...
class DigitalDenAPITester:
    def __init__(self, base_url="https://digitalden.preview.emergentagent.com"):
...
def main():
    print("🚀 Starting DigitalDen Backend API Tests")
    print("=" * 50)
    
    # Setup
    tester = DigitalDenAPITester()
